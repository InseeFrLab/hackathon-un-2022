...
```{ojs}
viewof nomenclature = Inputs.checkbox(
  ["ShiptypeLevel1", "ShipTypeLevel2"], 
  { value: ["Niveau 1", "Niveau 2"], 
    label: "Nomenclature:"
  }
)
```
...
```{python}
#| include: false
fig1 = fc.waffle_chart_zone(AIS_enriched, by = "ShiptypeLevel1")
fig2 = fc.waffle_chart_zone(AIS_enriched, by = "ShipTypeLevel2")
```
